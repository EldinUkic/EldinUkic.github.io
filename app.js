...
// 6. GridHelper für Cyberpunk-Boden
const size = 20;
const divisions = 40;
const gridHelper = new THREE.GridHelper(size, divisions, 0x00ffcc, 0x00ffcc);
gridHelper.rotation.x = Math.PI / 2;   // waagrecht drehen
gridHelper.position.y = -1.5;          // etwas unter den Würfel legen
